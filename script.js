...
async function getQuestions(category) {
    const API_URL = `https://opentdb.com/api.php?amount=30&category=18&type=multiple&category=${encodeURIComponent(category)}`;
    // https://www.trivianerd.com/topic/technology-trivia=${encodeURIComponent(category)}`;
    //`https://opentdb.com/api.php?amount=30&category=18&type=multiple&category=${encodeURIComponent(category)}`;
    //`https://opentdb.com/api.php?amount=50&type=18&type=multiple&category=${encodeURIComponent(category)}`;
    //`https://opentdb.com/api.php?amount=20&type=multiple&category=${encodeURIComponent(category)}`;
    try {
